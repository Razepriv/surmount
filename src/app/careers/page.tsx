  ...
  return (
    <main className="min-h-screen bg-[var(--color-cloud-white)]">
      <Section className="relative pt-48 pb-12 bg-[var(--color-summit-black)] text-white">
        <Container>
          <FadeIn direction="up">
            <h1 className="text-5xl md:text-8xl font-display mb-8">Join the Climb</h1>
      ...
      <Section className="bg-white">
        <Container>
           <div className="max-w-4xl mx-auto">
                     ...
                     <div className="group border border-[var(--color-platform-gray)] hover:border-[var(--color-surmount-red)] bg-[var(--color-cloud-white)] p-8 transition-all duration-300">
                       <div className="flex flex-col md:flex-row md:items-center justify-between">
                         <div className="mb-6 md:mb-0">
                           ...
                           <div className="flex items-center text-sm text-[var(--color-stone-gray)] space-x-4 mb-4">
                              <span className="flex items-center"><Briefcase className="w-4 h-4 mr-2" /> {job.department}</span>
                              <span className="w-1 h-1 bg-[var(--color-stone-gray)] rounded-full"></span>
                              <span>{job.location}</span>
                              <span className="w-1 h-1 bg-[var(--color-stone-gray)] rounded-full"></span>
                              <span>{job.type}</span>
                           </div>
                           <p className="text-[var(--color-deep-charcoal)] leading-relaxed max-w-2xl">{job.description}</p>
                         </div>
                         <Button variant="outline" className="shrink-0 self-start md:self-center">
             ...
             <div className="mt-16 bg-[var(--color-deep-charcoal)] text-white p-12 text-center rounded-sm">
